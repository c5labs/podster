...
namespace Concrete\Package\Podster\Block\PodsterSubscribeButton;
...
class Controller extends BlockController
{
     ...
     * @var string
     */
    protected $btName = 'Podster Subscribe Button';
     ...
     * @var string
     */
    protected $btDescription = 'Podster subscribe button for the podster podcasting solution.';
     ...
     * @var string
     */
    protected $btHandle = 'podster_subscribe_button';
     ...
     * @var string
     */
    protected $btTable = 'btPodsterSubscribeButton';
